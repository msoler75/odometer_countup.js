...
var Odometer = /** @class */ (function () {
    ...
    Odometer.prototype.render = function (elem, formatted) {
        ...
        var transitionDigit = "transform ".concat(this.options.duration, "s ease-out");
        ...
        function pushDigit(cell, newDigit) {
            ...
            var now = +new Date();
            var delayTime = this.options.delay * 1000 - (now - cell.lastTimeAdd);
        ...
        var _loop_1 = function () {
            ...
            if (cell.current != ch) {
                ...
                }, ((this_1.options.duration || 0.8) + (this_1.options.duration || 0.25)) *
                    1000 +
